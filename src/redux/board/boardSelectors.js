...
export const selectFilteredBoards = state => state.boards.filteredBoards;
export const selectStats = state => state.boards.stats;
export const selectAllCards = state => state.boards.allCards;